...
const b12 = [...a1, ...a2]; // taip vyksta masyvo kopijavimas
console.log(b12);
...
const [...mAll] = mix; // suzinom visus masyvo mix narius
...
const {name, age, ...p} = person; //objektai neturi eiliskumo, todel reikia nurodyti objekto rakto pavadinima.
