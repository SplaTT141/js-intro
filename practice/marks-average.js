function marksAverage(list) {
    ...
    // sumojame visus skacius ir ju kieki:
    let sum = 0;
    let count = 0
    //    einame per visa masyva ir imam kiekviena skaiciu
    //    jei sutinkame ne skaiciu, tai ji ignoruojame
    //    jei sutinkame skaiciu, kuris nera sveikasis 1 iki 10 (imtinai), tai ignoruojame
