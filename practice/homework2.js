...
if (
  typeof arr8[0] === "string" &&
  typeof arr8[1] === "string" &&
  typeof arr8[2] === "string"
) {
...
if (Math.max(...arr9) > 10) {
  console.log(
    `Didziausias skaicius yra : ${Math.max(...arr9)} ir jis yra > 10`
  );
} else {
  console.log(
    `Didziausias skaicius yra : ${Math.max(...arr9)} ir jis yra < 10`
...
function rockPaperScissors(vask) {
  const akmuo = 0;
  const popierius = 1;
  const zirkles = 2;
  ...
  switch (vask) {
    case "akmuo":
      console.log(`Zaidejas rodo AKMENI`);
      vask = 0;
      break;
    case "popierius":
      console.log(`Zaidejas rodo POPIERIU`);
      vask = 1;
      break;
    case "zirkles":
      console.log(`Zaidejas rodo ZIRKLES`);
      vask = 2;
      break;
    default:
      return "Ivesta neteisinga reiksme";
  }

  if (pc === akmuo) {
    console.log("Kompiuteris rodo AKMENI");
  } else if (pc === popierius) {
    console.log("Kompiuteris rodo POPIERIU");
  } else if (pc === zirkles) {
    console.log("Kompiuteris rodo ZIRKLES");
  }
...
console.log(rockPaperScissors("akmuo"));

console.clear();

//2

function weights(weight, weightPerPerson) {
  const persons = weight / weightPerPerson;
  return Math.ceil(persons);
}

console.log(weights(110, 20));
